...
v4 turns CF Compass from a collection of training pages into a coherent desktop workbench. v4.0.2 fixes blank profile avatars when a Codeforces image source is temporarily unavailable.
...
See the [v4.0.2 release notes](./docs/releases/v4.0.2.md), [v4.0.1 release notes](./docs/releases/v4.0.1.md), and the complete [v4.0.0 feature notes](./docs/releases/v4.0.0.md).
...
```text
Windows x64 (recommended installer): CF-Compass-4.0.2-Windows-x64-Setup.exe
Windows x64 (portable):              CF-Compass-4.0.2-Windows-x64-portable.exe
