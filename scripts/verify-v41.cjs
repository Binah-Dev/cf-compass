...
const ui = ['qa-issue-25-virtual.cjs', 'qa-workbench-layout.cjs', 'benchmark-interactions.cjs', 'qa-material-quarantine.cjs', 'qa-template-summary-persistence.cjs', 'qa-study-plan.cjs', 'qa-issue-13-layout.cjs', 'qa-typography.cjs', 'qa-electron.cjs'];
const results = [];
